...
public class ModItemGroups {
    public static final ItemGroup PINK_GARNET_ITEMS_GROUP = Registry.register(Registries.ITEM_GROUP, Identifier.of(KaupenJoeTutorial.MOD_ID, "pink_garnet_items"), FabricItemGroup.builder()
            ...
            .entries((displayContext, entries) -> {
                ...
                entries.add(ModItems.RAW_PINK_GARNET);
                    ...
                    .build());
    public static final ItemGroup PINK_GARNET_BLOCKS_GROUP = Registry.register(Registries.ITEM_GROUP, Identifier.of(KaupenJoeTutorial.MOD_ID, "pink_garnet_blocks"), FabricItemGroup.builder()
